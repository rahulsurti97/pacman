	lab8_soc u0 (
		...
		.ghost_direction_export_export (<connected-to-ghost_direction_export_export>), // ghost_direction_export.export
		.ghost_status_export_export    (<connected-to-ghost_status_export_export>)     //    ghost_status_export.export
	);
